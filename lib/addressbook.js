...
module.exports = function createAddressBook (opts) {
  ...
  const byPermalink = subdown(db, 'r', { valueEncoding: 'utf8' })
  utils.addLiveMethods(byPermalink, processor)

  const index = subdown(db, 's', { valueEncoding: 'utf8' })
