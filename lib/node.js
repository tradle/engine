...
proto.saveObject = function saveObject (wrapper, cb) {
  ...
  function createAction (done) {
    ...
    if (wrapper.link === 'ab8188486e1a3c407fd54b13f39fd91aaa2b45444c1893aae7f54d4d32d6f355') debugger
...
proto.pause = function (timeout) {
  ...
  this._paused = true
  if (!this._ready) return this.once('ready', () => this.pause(timeout))

  this._exec('pause')
  if (timeout) utils.timeout(this.resume, timeout, true)
}
