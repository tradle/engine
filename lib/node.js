...
const statuses = tradle.constants.status
...
proto.seal = function (opts, cb) {
  ...
  this.msgDB.hasSealWithID(sealID, function (err, exists) {
    ...
    self.changes.append({
      ...
      sealPrev: object[PREV_HASH] && protocol.sealPrevPubKey({
        object: object,
        basePubKey: basePubKey
      }),
      type: object[TYPE],
...
proto._trackchain = function () {
  ...
  const chaintracker = this.chaintracker = opts.chaintracker || trackchain({
