...
Tradle.prototype.seal = function seal (opts, cb) {
  ...
  if (!network) throw new Error('expected "network"')
...
Tradle.prototype.watchNextVersion = function (opts, cb) {
  ...
  const address = utils.sealPrevAddress({
    network: this._getNetwork(chain),
    basePubKey,
    headerHash
  })
...
Tradle.prototype._getNetwork = function (chain) {
  return this.getBlockchainAdapter(utils.networkToIdentifier(chain))
}
