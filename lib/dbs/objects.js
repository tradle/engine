...
function createObjectDB (opts) {
  ...
  function byType (type, opts, cb) {
    ...
    return collect(indexes.type.createReadStream(opts), cb)
  }
  ...
  return utils.extend(emitter, {
    ...
    sealed: function (minConfirmations) {
      return indexes.confirmations.createReadStream({ gte: minConfirmations || 0 })
    },
