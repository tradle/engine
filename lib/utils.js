...
utils.find = function (arr /* filters */) {
  let match
...
utils.sigKey = keys => utils.find(keys, isSigningKey, isPrivateKey)
...
utils.identityVersioningKey = keys => utils.find(keys, isIdentityVersioningKey, isPrivateKey)
...
utils.chainKey = keys => utils.find(keys, isChainKey, isPrivateKey)
 ...
 * @return {nkeyModule}
 */
utils.getKeyImplementation = function (spec) {
