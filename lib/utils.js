...
const nkeyImpls = Object.freeze({
  get ec () { return require('nkey-ecdsa') },
  get curve25519 () { return require('nkey-curve25519') },
  get bitcoin () { return require('nkey-bitcoin') },
  get ethereum () { return require('nkey-ethereum') }
})
const debug = require('debug')('tradle:utils')
const protocol = require('@tradle/protocol')
const putils = require('@tradle/protocol/utils')
...
exports.ecPubKeysAreEqual = putils.ecPubKeysAreEqual
exports.assert = putils.assert
exports.sign = putils.sign
exports.parseSig = putils.parseSig
...
exports.throttledQueue = (millis) => {
  ...
  const pollQueue = () => {
    ...
    try {
      ...
      debug('throttled blockchain call failed', err.message)
    }
