...
exports.getLinks = function getLinks (wrapper) {
  ...
  const links = {
    link: wrapper.link || utils.hexLink(wrapper.object),
    prevlink: wrapper.prevlink || wrapper.object[PREVLINK],
    permalink: wrapper.permalink || wrapper.object[PERMALINK] || wrapper.link
  }
